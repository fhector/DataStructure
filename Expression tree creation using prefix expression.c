/*
wacp to construct an expression tree using a prefix expression. Then use the expression tree to display the postfix and infix form of same prefix expression
*/
