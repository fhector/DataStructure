/* Postfix Infix -  Program to convert given postfix expression to Infix expression*/

/* We assume that the operators are +,-,*,/,$ and
...
Note:
The stacktop() and pop() functions need not have provision for
checking whether the stack is empty since postfix() takes care of
this before calling them.
*/
